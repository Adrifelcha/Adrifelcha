    ...
    tabItems(
      ...
      tabItem(tabName = "defin",
              ...
              fluidRow(column(width=5, offset = 1, background = 'yellow',
                              ...
                              HTML('<h4 style="text-align:justify;"> También llamada <b>Curva Normal</b> o <b>Campana de Gauss</b>, la Distribución Normal describe la probabilidad de que se encuentren ciertos <b>valores (x)</b> en una <b>observación aleatoria</b> de una variable cualquiera (peso, altura, puntuación IQ, etc.).</h4>'),
                              HTML('<h4 style="text-align:justify;"> La Distribución Normal está definida por dos parámetros: <b>la media</b> (el valor (x) promedio, con la mayor probabilidad de ser observado de manera aleatoria) y <b>la desviación estándar</b> (un indicador de qué tanto se aleja el resto de los valores (x) observados en la variable de su media).</h4>'),
                              HTML('<h4 style="text-align: justify;">Se trata de la <b>distribución de probabilidad continua</b> más utilizada en las ciencias sociales y naturles, pues dadas sus propiedades permite dar cuenta de cómo se distribuyen los <b>valores</b> observados en <b>variables</b> específicas y utilizar esta información para hacer comparaciones entre <b>poblaciones</b> particulares, o bien entre <b>muestras</b> sometidas a procedimientos distintos.</h3>'),
