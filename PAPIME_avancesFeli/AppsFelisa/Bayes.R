...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    sidebarMenu(
      ...
      menuItem("Probabilidad (Conceptos bÃ¡sicos)", tabName = "prob", icon = icon("star-o")),
    ...
    tabItems(
      ...
      tabItem(tabName = "defin",
              ...
              fluidRow(column(width=5, offset = 1, background = 'yellow',
                              #fluidRow(box(   
                              HTML('<h2 style="text-align:center; color:#DF0101;"><b>DescripciÃ³n general</b></h2>'),
                              ...
                              HTML('<h4 style="text-align:justify;"> El	Teorema	de	Bayes (tambiÃ©n	conocido	como Regla	de	Bayes) permite	estimar	la	<b>probabilidad</b> (<i>p</i>)	de	que	un	determinado	evento <i>A</i>	ocurra, con base en la	observaciÃ³n	de	cierta	evidencia <i>B</i>; (<i>p(A|B)</i>). El Teorema de Bayes se expresa como:.</h4>'),
                              withMathJax("$$p(A|B) = \\frac{p(A) \\cdot p(B|A)}{p(B)}$$"),
                              HTML('<h4 style="text-align:justify;"> En otras palabras, la Regla de Bayes actualiza el estimado original sobre la probabilidad de ocurrencia de <i>A</i> en el mundo (la <b>probabilidad prior</b>; <i>p(A)</i>), con base en la correlaciÃÂ³n que se sabe que tiene con la presentaciÃÂ³n del evento <i>B</i> (la <b>verosimilitud</b>; <i>p(B|A)</i>), que tambiÃÂ©n puede presentarse por sÃ­ solo (la <b>verosimilitud marginal</b>, <i>p(B)</i> (<i>donde p(BN) = p(AnB) + p(A"n B) </i>) que ya ha sido observado y funge como evidencia para computar la probabilidad final (la <b>probabilidad posterior</b>, <i>p(A|B)</i>).</h4>'),
                              wellPanel(HTML('<h4>a) Si yo sÃ© cuÃ¡l es  <b>la estatura promedio</b> de las mujeres en mi familia, Â¿quÃ© predicciones puedo hacer sobre la estatura que tendrÃ¡ mi sobrina cuando crezca?.</h4>')),
      ...
      tabItem(tabName = "media",
              fluidRow(HTML('<h1 style="text-align:center; color:purple;"><b><u>DistribuciÃÂÃÂÃÂÃÂ³n  Normal</u></b></h1>'),
                              ...
                              fluidRow(column(width=2, offset=1,
                                       ...
                                       column(width=2,
                                              wellPanel(numericInput(inputId="val_5", 
                                                                     ...
                                                                     value=1, min=0, max=10,
                                                                     width='150px')))),
                              HTML('<h4 style="text-align: justify;">La media funciona como una <b>medida de tendencia central</b> que permite describir en torno a quÃÂÃÂÃÂÃÂ© valor se distribuyen las observaciones de cierta variable.</h3>')),
      ...
      tabItem(tabName = "desv",
              fluidRow(HTML('<h1 style="text-align:center; color:purple;"><b><u>DistribuciÃÂÃÂÃÂÃÂ³n  Normal</u></b></h1>'),
                       HTML('<p style="text-align:center;"><b>por Adriana F. ChÃÂÃÂÃÂÃÂ¡vez</b></p>')),
              fluidRow(column(width=5, offset = 1, background = 'yellow',
                              HTML('<h1 style="text-align:center; color:purple;"><b>La DesviaciÃÂÃÂÃÂÃÂ³n EstÃÂÃÂÃÂÃÂ¡ndar</b></h1>'),
                              HTML('<hr style="border: 0; height: 1px; background-image: -webkit-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0); background-image: -moz-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0); background-image: -ms-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0); background-image: -o-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0);"'),
                              HTML('<h3 style="text-align:justify;"> La desviaciÃÂÃÂÃÂÃÂ³n estÃÂÃÂÃÂÃÂ¡ndar es una <b>medida de dispersiÃÂÃÂÃÂÃÂ³n</b> de los valores registrados, que nos informa quÃÂÃÂÃÂÃÂ© tanto se alejan estos de la <b>media</b>.</h3>'),
                              HTML('<h3 style="text-align:justify;"> La <b>desviaciÃÂÃÂÃÂÃÂ³n estÃÂÃÂÃÂÃÂ¡ndar</b> se define como <b>la raÃÂÃÂÃ­z cuadrada de la varianza</b>.</h3>'),
                              tags$br(),
                              tags$br(),
                              HTML('<h2 style="text-align:center; color:purple;"><b>La varianza</b>.</h2>'),
                              HTML('<h3 style="text-align:justify;"> La varianza estÃÂÃÂÃÂÃÂ¡ definida como <b>el promedio de las diferencias cuadradas entre cada valor individual, y la media</b> de la muestra ÃÂÃÂÃÂÃÂ³ poblacion de donde se estrajo.</h3>'),
                              fluidRow(column(width=2, offset=1,
                                              wellPanel(numericInput(inputId="val_1", 
                                                                     label = "Dato 1",
                                                                     value=1, min=0, max=10,
      ...
      tabItem(tabName = "prop",
              ...
              fluidRow(column(width=5, offset = 1, background = 'yellow',
                              ...
                              HTML('<hr style="border: 0; height: 1px; background-image: -webkit-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0); background-image: -moz-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0); background-image: -ms-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0); background-image: -o-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0);"'),
                              HTML('<h3 style="text-align:justify;"> TambiÃÂÃÂÃÂÃÂ©n llamada <b>Curva Normal</b> o <b>Campana de Gauss</b>, una distribuciÃÂÃÂÃÂÃÂ³n de probabilidad Normal estÃÂÃÂÃÂÃÂ¡ definida por los siguientes parÃÂÃÂÃÂÃÂ¡metros:</h3>'),
                              HTML('<h4 style="text-align: justify;">Se trata de una <b>distribuciÃÂÃÂÃÂÃÂ³n de probabilidad continua</b> que describe la probabilidad de que se observe cierto <b>valor (x)</b> si extraigo <b>aleatoriamente</b> un elemento perteneciente a cierta <b>muestra</b> o <b>poblaciÃÂÃÂÃÂÃÂ³n</b>.</h3>'),
                              HTML('<h4 style="text-align: justify;">La DistribuciÃÂÃÂÃÂÃÂ³n Normal es muy utilizada en las ciencias sociales y naturles, pues permiten describir la forma en que los <b>valores</b> observados en ciertas <b>variables</b> se distribuyen al rededor de su <b>media</b> (<i>a.k.a. el promedio de las observaciones recopiladas</i>).</h3>')),
      ...
      tabItem(tabName = "Glos",
              fluidRow(HTML('<h1 style="text-align:center; color:purple;"><b><u>G L O S A R I O</u></b></h1>'),
                       HTML('<p style="text-align:center;"><b>(checa aquÃÂÃÂÃ­ los conceptos con los que no estÃÂÃÂÃÂÃÂ©s familiarizado)</b></p>')), 
              ...
              fluidRow(column(width=5, offset = 1, background = 'yellow',
                              HTML('<h4 style="text-align: justify;"><b>DistribuciÃÂÃÂÃÂÃÂ³n de probabilidad contÃÂÃÂÃ­nua:</b></h3>'),
                              HTML('<h4 style="text-align: justify;"><b>Muestra y PoblaciÃÂÃÂÃÂÃÂ³n:</b></h3>')),
                       column(width=5, offset = 0, 
                              HTML('<h4 style="text-align: justify;"><b>Muestra y PoblaciÃÂÃÂÃÂÃÂ³n:</b></h3>'))),
              fluidRow(HTML('<hr style="border: 0; height: 1px; background-image: -webkit-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0); background-image: -moz-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0); background-image: -ms-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0); background-image: -o-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0);"')
              )
