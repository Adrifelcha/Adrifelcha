...
\newlength{\datebox}\settowidth{\datebox}{Enero 2019} % Set the width of the date box in each block
...
\NewEntry{Origen}{\textit{México, CDMX}}{7-Marzo-1993 (25 años)}\\ % Birthplace and date
...
\Description{Licenciada en Psicología con énfasis en la Psicología Experimental (análisis experimental del comportamiento: metodología y diseño experimental, manejo y graficación de bases de datos con paqueterías de R y Python, y modelamiento bayesiano). Mis aptitudes e intereses están orientados a la investigación básica y aplicada.}\vspace{1em} % Goal text
...
\Description{\MarginText{Redacción} \LaTeX, OpenOffice}
\Description{\MarginText{Sistema Operativo}\textsc{Mac}, \textsc{Windows}}
\Description{\MarginText{Manejo de datos}\textsc{R} (IDE: RStudio), \textsc{Python} (IDE: Spyder), \textsc{SPSS} y \textsc{JASP}}
\Description{\MarginText{Programación Experimental}\textsc{Python} (PsychoPy)}
\Description{\MarginText{Programación Web}\textsc{HTML}, \textsc{CSS}; {\href{www.bouzaslab25.com}{www.bouzaslab25.com}} y {\href{www.bouzaslab25/LabVirtual25.com}{www.bouzaslab25/LabVirtual25.com}}}
