...
\Description{Licenciada en Psicología con énfasis en la Psicología Experimental. Mis aptitudes e intereses están orientados a la investigación básica y aplicada, y al manejo y análisis de bases de datos.}\vspace{1em} % Goal text
...
\Description{\MarginText{Programación de Sitios Web}\textsc{HTML}, \textsc{CSS}}
