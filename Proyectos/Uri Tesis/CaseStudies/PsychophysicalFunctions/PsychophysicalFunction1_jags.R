...
data <- list("x","xmean","n","r","nsubjs","nstim") # to be passed on to JAGS
set.seed(10) # the initial values need to be set just right
myinits <-	list(
  list(mua = 0, mub = 0, sigmaa = 1, sigmab = 1, alpha = -2 + 4*runif(nsubjs), beta = .5 * runif(nsubjs)),
  list(mua = 0, mub = 0, sigmaa = 1, sigmab = 1, alpha = -2 + 4*runif(nsubjs), beta = .5 * runif(nsubjs)),
  list(mua = 0, mub = 0, sigmaa = 1, sigmab = 1, alpha = -2 + 4*runif(nsubjs), beta = .5 * runif(nsubjs)))
