...
\begin{figure}[th]
\centering
\includegraphics[width=0.5\textwidth]{Figures/Ejemplo_EnsayoYN_1} \includegraphics[width=0.5\textwidth]{Figures/Ejemplo_EnsayoYN_2}
\includegraphics[width=0.5\textwidth]{Figures/Ejemplo_EnsayoYN_4} \includegraphics[width=0.5\textwidth]{Figures/Ejemplo_EnsayoYN_3}
%\decoRule
...
Esta forma de obtener la escala de confianza a partir de la yuxtaposición entre las respuestas de los participantes a la tarea binaria y la valoración de su confianza en las mismas, corresponde con el método utilizado en los Experimentos 1 y 2 de una serie de estudios reportados en Memoria de Reconocimiento, como una forma de facilitar la tarea para los participantes, evitar su fatiga y garantizar que exista coherencia entre la respuesta dada en la tarea de bisección y el puntaje de confianza asignado  \parencite{Glanzer1990}
