...
En la primera fase, (la tarea de respuesta binaria 'Sí/No'), se mostraba a los participantes el estímulo que contenía la pareja de círculos a comparar con un par de leyendas en la parte superior e inferior de la pantalla que recordaban a los participantes la pregunta de detección a responder (i.e. ¿Los círculos centrales son del mismo tamaño?) y las teclas que debían presionar para emitir su respuesta (i.e. 'S = Sí, N = No'), respectivamente. Los estímulos permanecían durante 1.5 s antes de desaparecer, (dejando únicamente las leyendas en pantalla), para preveer la habituación de los participantes a la ilusión al emitir su respuesta. Los estímulos permanecían en pantalla durante el tiempo estipulado, con independencia de si se hubiera o no emitido una respuesta en dicho intervalo. Una vez habiendo desaparecido el estímulo, los recordatorios permanecían en pantalla hasta que el participante registrara una respuesta.
