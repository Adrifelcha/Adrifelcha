...
%Detectar ciertos estados en el mundo nos ayuda a guiar nuestro comportamiento
...
Determinar que 'algo' está o no ocurriendo parecería no ser un problema significativo si asumimos que dichos eventos aparecen de manera inconfundible y con perfecta claridad, o bien, que los sistemas comprometidos en tal tarea cuentan con detectores altamente sensibles que garantizan su identificación infalible. Sin embargo, difícilmente este es el caso. Comúnmente, la información a partir de la cual queremos juzgar si algo está o no ocurriendo es confusa y puede malinterpretarse como evidencia de un estado diferente del mundo. Por ejemplo: el adolescente que quiere conseguir un permiso para ir de fiesta necesita encontrar el momento ideal para pedírselo a su mamá, cuando ella esté de muy buen humor, y para ello cuenta con indicadores poco precisos como podrían ser los gestos, el tono de voz o las actividades que su madre realice durante el día. Equivocar el diagnóstico del estado anímico de la madre y obtener una negativa al permiso solicitado es un riesgo latente, ya sea por una mala lectura de los datos disponibles (en nuestro ejemplo previo, puede que las ansias del adolescente por salir de fiesta le hagan apresurar el momento) o bien porque los datos son poco claros en sí mismos (la mamá en cuestión podría ser una persona particularmente poco expresiva).\\ 

%Los eventos que interesa detectar se encuentran constantemente rodeados de ruido
 Cuando hablamos de la detección de un estado o evento como un problema de adaptabilidad, estamos asumiendo que el sistema que se enfrenta a dicha tarea lo está haciendo dentro de un entorno donde la presentación de dichos evento o estados es aleatoria y donde estará expuesto a otro tipo de eventos.\\

%La detección de eventos se convierte en un problema adaptativo, donde se compensa la incertidumbre con el conocimiento que se tiene de la tarea y el entorno en que esta tiene lugar.
...
%La Teoría de Detección de Señales admite la importancia de la incertidumbre: El ruido y la señal.
