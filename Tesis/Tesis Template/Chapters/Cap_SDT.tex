...
En este capítulo se expone a detalle el modelo estadístico que protagoniza la presente tesis. Se trata de uno de los modelos más importantes en el desarrollo de la psicología científica y que, aún a la fecha, sigue formando parte importante en el estudio de fenómenos psicológicos donde la tarea primordial de los organismos consiste en la detección de señales específicas en su entorno que permitan guiar su comportamiento de manera óptima.\\
