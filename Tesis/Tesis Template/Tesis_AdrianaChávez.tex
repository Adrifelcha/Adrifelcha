...
La Teoría de Detección de Señales (TDS; SDT en ingles) y el modelo que de ella deriva, constituye uno de los modelos más sólidos y ampliamente estudiados en Psicología. Sus supuestos se han generalizado hasta permitir su aplicación al estudio de distintos fenómenos dentro y fuera de la psicología, donde el desempeño de participantes experimentales en tareas binarias donde se les solicita que indiquen si detectan, o no, la presencia de un estímulo o clase de estímulos en particular, describiendo su ejecución a partir de los aciertos y errores cometidos en la emisión de dichos juicios de detección ('Sí, lo que se me pidió detectar está presente', o 'no, no lo está') y permitiendo su interpretación en términos de de la precisión con que los participantes distinguen la señal del ruido y posibles sesgos que los lleven a reportar la presencia o ausencia de la señal.\\
