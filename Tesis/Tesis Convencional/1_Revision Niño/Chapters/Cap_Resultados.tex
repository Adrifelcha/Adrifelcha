...
\begin{table}
\caption[Pruebas Binomiales que comparan la proporción de casos encontrados con el Efecto Espejo]{Se presetan los resultados de la comparación entre la proporción de casos con el Efecto Espejo encontrados en cada experimento y el azar ($p=0.5$), de acuerdo con pruebas binomiales.}
\label{Tabla_Binom}
\centering
