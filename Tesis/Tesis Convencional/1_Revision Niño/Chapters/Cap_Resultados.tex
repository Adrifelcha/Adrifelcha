...
\begin{table}
\caption[Pruebas Binomiales que comparan la proporción de casos encontrados con el Efecto Espejo]{Se presetan los resultados de las pruebas T de una muestra para la comparación de las medias de las tasas crudas registradas por cada clase de estímulo y de su transformación arcoseno, para los Experimentos 1 y 2.}
\label{Tabla_Binom}
\centering
...
\begin{table}
\caption[Prueba T para evaluar diferencias entre las tasas de ejecución (Hits y F. Alarmas) promedio registradas por cada condición]{Se presetan los resultados de las pruebas T de una muestra para la comparación de las medias de las tasas crudas registradas por cada clase de estímulo y de su transformación arcoseno, para los Experimentos 1 y 2.}
...
En la Figura~\ref{fig:Mod_Tau} se presenta el modelo gráfico coorrespondiente al Modelo Tau desarrollado para evaluar la evidencia del Efecto Espejo encontrada en los experimentos realizados. El modelo cuenta con los mismos elementos que el Modelo Delta desarrollado para comparar las medias de $d'$ por cada clase de estímulo, con las siguientes excepciones:\\
...
\begin{table}
\caption[Prueba T bayesiana para evaluar diferencias en las medias de los puntajes de confianza asigandos entre condiciones]{}
...
%RT1  A vs B
\begin{table}
\caption[Tiempo de Respuesta a la tarea Sí/No por clase de estímulo]{Prueba t para comparar el Tiempo de Respuesta a la Tarea binaria "Sí/No" entre clases de estímulos}
\label{Tabla_RT1_AB}
\centering
\begin{tabular}{l |  c c c c}
\toprule
...
%RT1  AS vs AN
\begin{table}
\caption[Tiempo de Respuesta a la tarea Sí/No para la clase A (Señal vs Ruido)]{Prueba t para comparar el Tiempo de Respuesta a la Tarea binaria "Sí/No" a los estímulos con Señal y Ruido de la clase A}
\label{Tabla_RT1_A}
\centering
\begin{tabular}{l |  c c c c}
\toprule
...
%RT2  AS vs AN
\begin{table}
\caption[Tiempo de Respuesta a la tarea Sí/No para la clase A (Señal vs Ruido)]{Prueba t para comparar el Tiempo de Respuesta a la Tarea con Escala de Confianza los estímulos con Señal y Ruido de la clase A}
\label{Tabla_RT2_A}
\centering
\begin{tabular}{l | c c c c}
\toprule
...
%RT1  BS vs BN
\begin{table}
\caption[Tiempo de Respuesta a la tarea Sí/No para la clase A (Señal vs Ruido)]{Prueba t para comparar el Tiempo de Respuesta a la Tarea binaria "Sí/No" a los estímulos con Señal y Ruido de la clase B}
\label{Tabla_RT1_B}
\centering
\begin{tabular}{l |  c c c c}
\toprule
...
%RT2  BS vs BN
\begin{table}
\caption[Tiempo de Respuesta a la tarea Sí/No para la clase A (Señal vs Ruido)]{Prueba t para comparar el Tiempo de Respuesta a la Tarea con Escala de Confianza los estímulos con Señal y Ruido de la clase B}
\label{Tabla_RT2_B}
\centering
\begin{tabular}{l |  c c c c}
\toprule
