...
\emph{Sinodales:} \\
\href{germanpalafox@gmail.com}{Sinodal 1}\\ % Supervisor name - remove the \href bracket to remove the link  
\href{germanpalafox@gmail.com}{Sinodal 2}\\ % Supervisor name - remove the \href bracket to remove the link  
\href{germanpalafox@gmail.com}{Sinodal 3}\\ % Supervisor name - remove the \href bracket to remove the link  
\end{center}
\end{minipage}\\[1.3cm]
...
%Y gracias a Juan Pablo Aguayo Chávez -¡JUANCHO!- por ser mi hermano mayor... (\textit{Quiere una copia de la tesis y no le he escrito nada!})\\
...
%Jaime, eres ante todo, mi compañero de vida. De todas las personas con quienes me he cruzado en esta vida eres a quien más admiro, mi mejor amigo, el colega más nutritivo, el desconocido más intrigante. En cuantas vidas viva, en todas te amaré.\\

3. Al Lab25\\

%Gracias a Manuel Villareal, José Luis Baroja y Melisa Chávez, por todo su apoyo. Gracias a Elena Villalobos e Itzel Laurel,\\  
...
%AQUI VA EL PARRAFO SUPER VERGAS DE NIÑO (Es sorpresa!).\\

%Niño, eres alguien a quien admiro mucho. Dices que no reconoces la palabra 'mi amigo', 'mi amiga' en tu vocabulario, y sin embargo, haz hecho por mí más que mucha gente a quien yo he asignado esa etiqueta.


%Niño, muchísimas gracias por las 16 horas que invertiste siendo mi primer revisor "no-oficial". Gracias por ser mi terapeuta personal. Eres alguien a quien estimo muchísimo y de quien admiro a sobremanera su enorme capacidad para adaptarse a cualquier entorno. Gracias por ser mi amigo Wikipedia; porque no importa qué te cuente o sobre qué tenga dudas... siempre es algo que tú hiciste primero (winky face).\\
