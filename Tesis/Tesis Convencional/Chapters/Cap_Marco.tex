...
Aceptar la TDS como marco para la descripción de tareas en Memoria implica asumir que el "input" con base en el cual los participantes emiten sus respuestas son los valores evaluados en cada ensayo, que representan puntos sobre el eje de evidencia sobre el cual se despliegan las distribuciones de Ruido (los estímulos distractores) y Señal (los estímulos a identificar de acuerdo al procedimiento empleado). Es decir, el desempeño observado es interpretado como resultado de la interacción entre la "fuerza de memoria" evaluada en cada ensayo y un proceso de decisión que determina cuando ésta es lo suficientemente grande para juzgar la pertenencia de los estímulos a la categoría "conocida".\\ 

En términos de la exploración de este supuesto y sus implicaciones, resaltan los trabajos orientados a evaluar la naturaleza de tal "fuerza de memoria" (por ejemplo, si puede definirse como una serie de valores contínuos o discretos), y a estudiar la interacción entre los procesos cognitivos involucrados en memoria y la adquisición o la pérdida de dicha fuerza (por ejemplo, el estudio, la retención y el olvido), \parencite{Bernbach1967, Wickelgren1966, Parks1966}.

\item La noción del Criterio de Elección como opuesta a los Umbrales de respuesta.\\

Una de las ventajas más evidentes de la aplicación de la TDS al estudio de la memoria es que permite entender los Falsos Positivos en términos de la confusión entre la evidencia -la "fuerza de memoria"- elicitada por los estímulos Ruido y los estímulos Señal (el sobrelape entre las distribuciones). Es decir, en vez de plantear el problema en términos de "umbrales de estimulación" que deben ser rebasados para poder ""

\item La noción de que existen distribuciones subyacentes (y la definición de sus características).\\

Las MOC se construyen a partir de los datos obtenidos en los experimentos, y permiten a su vez hacer inferencias sobre el tipo de distribución que mejor describe los datos.

\item Análisis de datos y descripción del desempeño de los participantes.\\

Finalmente, se encuentran los trabajos que se limitan a utilizar la TDS como una herramienta para interpretar los datos obtenidos en estudios de memoria que incorporan la metodología asociada con las tareas de detección, \parencite{Marks1964}.
...
Dentro del estudio de la Memoria, uno de los sub-campos de aplicación más comúnes de la TDS es el de la Memoria de Reconocimiento \parencite{Parks1966}.

Las Tareas en memoria de reconocimiento pueden entenderse como ... \parencite{Bernbach1967, Kintsch1967}
...
La aplicación de la TDS al estudio
