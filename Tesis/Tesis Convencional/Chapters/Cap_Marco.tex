...
Una tercera aproximación implica asumir que las clases de estímulos empleadas en estos estudios tienen un efecto sobre los procesos superiores involucrados en las tareas de reconocimiento. En otras palabras, este segundo conjunto de explicaciones asume que cada clase de estímulos A y B es procesada de manera diferencial por el participante. Por ejemplo, una de las primeras teorías en desarrollarse para dar cuenta del Efecto Espejo en Memoria de Reconocimiento es la Teoría de Atención/Verosimilityd \parencite{Glanzer1993}. Dicha teoría funciona como una teoría de muestreo de rasgos en la que se asume que todos los estímulos presentados están compuestos por un número fijo de rasgos ($N$), de los cuales, algunos se presentan "marcados" desde su primera aparición como "rasgos familiares" ($p(new$). Esta teoría asume que la diferencia fundamental entre  las clases de estímulos probadas ($i$) es que elicitan distintos gradientes de atención que van a repercutir en el número de rasgos atendidos ($n(i)$) dentro de la totalidad de los rasgos que componen cada estímulo. Es decir, cada clase de estímulo tiene su propia tasa de  "marcaje" ($\alpha(i)$). De tal forma que en la fase experimental de las tareas de reconocimiento, donde se asume que los participantes responden con base en el muestreo de rasgos de los estímulos evaluados, el número de rasgos marcados extraídos en cada ensayo resultará de una distribución binomial con probabilidad $p(i,j)$ (donde $j$ es el tipo de ensayo: nuevos o viejos) y un total de observaciones $n(i)$ (el número de rasgos atendidos en función a la clase del estímulo). Es decir:\\
