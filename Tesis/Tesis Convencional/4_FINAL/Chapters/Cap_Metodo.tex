...
%\decoRule
\caption[Tarea de detección binaria presentada (capturas de pantalla)]{Capturas de pantalla ilustrativas de la tarea de detección binaria presentada a los participantes; en el panel superior, se presenta un ensayo de la clase A y en el panel inferior, clase B.}
\label{fig:Ejem_YN}
\end{figure}
\end{center}
