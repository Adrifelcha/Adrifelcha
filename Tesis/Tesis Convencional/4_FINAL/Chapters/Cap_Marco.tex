...
De la misma forma que en la SDT clásica (McNicol, \citeyear{McNicol2, McNicol5}), se asume que los participantes sitúan múltiples criterios de elección sobre el eje de evidencia para definir qué puntaje de confianza emitirán por cada estímulo evaluado, dependiendo cuál sea el último en ser rebasado por la \textit{familiaridad} evaluada. La Figura~\ref{fig:Ejem_Efecto_Punt} ilustra la relación entre el promedio de los puntajes asignados a cada tipo de estímulos (Viejo o Nuevo x A o B) y el órden en que las cuatro distribuciones parecen desplegarse sobre el eje de evidencia; en general, las distribuciones de la clase A abarcan los valores más extremos del eje de evidencia y en consecuencia, en promedio se les asignan puntajes más extremos.\\
