...
\item En su forma clásica, la SDT asume que las distribuciones de Ruido y Señal son distribuciones normales equivariantes, (Stainslaw y Todorov, \citeyear{Stainslaw1999}).\\
  ...
  \end{itemize}
\item Se asigna de manera arbitraria una media en 0 a la distribución de Ruido, para facilitar el cómputo del resto de los parámetros. En otras palabras, la media de la distribución de Ruido es utilizada como punto de referencia para la estimación paramétrica, (Wickens, \citeyear{Wickens1}; \citeyear{Gescheider}).\\
