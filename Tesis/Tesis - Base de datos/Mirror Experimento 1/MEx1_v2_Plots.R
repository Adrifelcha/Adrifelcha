...
rm(list=ls())
pdf_name<-'PerTrial_Counters-H-FA-M-R.pdf'
pdf(file=pdf_name, width=8, height=8)
layout(matrix(1:4,ncol=2))
for(archive in dir()){
  jaime <- read.csv(archive)
...
rm(list=ls())
pdf_name<-'PerTrial_ConfidencceRMean.pdf'
pdf(file=pdf_name, width=8, height=8)
layout(matrix(1:4,ncol=2))
for(archive in dir()){
...
rm(list=ls())
pdf_name<-'PerTrial_RT1 & RT 2.pdf'
pdf(file=pdf_name, width=8, height=8)
layout(matrix(1:4,ncol=2))
for(archive in dir()){
  jaime <- read.csv(archive)
...
rm(list=ls())
pdf_name<-'Correlation_H&FA by Color.pdf'
pdf(file=pdf_name, width=8, height=8)
layout(matrix(1:4,ncol=2))
for(archive in dir()){
