...
\rput(7.5,10.5){\GM@node[nodeSize=15mm,
					%observed=true,
					observedColor=lightgray,
					%query=true
					]{Delta}}
					\rput(7.5,10.5){\GM@node[nodeSize=12mm]{Q_small}}
...
\rput(1.4,8.5){\GM@node[nodeSize=14mm,
					%observed=true,
					observedColor=lightgray,
					%query=true
					]{muca}}
...
\rput(2.6,8.5){\GM@node[nodeSize=14mm,
					%observed=true,
					observedColor=lightgray,
					%query=true
					]{lamca}}
...
\rput(4.1,8.5){\GM@node[nodeSize=14mm,
					%observed=true,
					observedColor=lightgray,
					%query=true
					]{muda}}
...
\rput(5.3,8.5){\GM@node[nodeSize=14mm,
					%observed=true,
					observedColor=lightgray,
					%query=true
					]{lamda}}
...
\rput(6.8,8.5){\GM@node[nodeSize=14mm,
					%observed=true,
					observedColor=lightgray,
					%query=true
					]{mucb}}
...
\rput(8,8.5){\GM@node[nodeSize=14mm,
					%observed=true,
					observedColor=lightgray,
					%query=true
					]{lamcb}}
...
\rput(9.3,8.5){\GM@node[nodeSize=14mm,
					%observed=true,
					observedColor=lightgray,
					%query=true
					]{mudb}}
           \GM@label[offset=-4mm]{mudb}{\huge$\mu^D_{Bi}$}

\rput(10.5,8.5){\GM@node[nodeSize=14mm,
					%observed=true,
					observedColor=lightgray,
					%query=true
					]{lamdb}}
           \GM@label[offset=-4.5mm]{lamdb}{\huge$\lambda^D_{Bi}$}
...
\rput(0.70, 0.9){\GM@plate[plateLabelPos=br]{10.5}{10.3}{\Large$i$ Sujeto}}
...
\rput(11.5,4.3){\pnode{equation}}\GM@label{equation}{\huge$D^A_{i}, D^B_{i}\sim \mathrm{Gaussian}\bigl(0,0.5)$}

\rput(11.5,3.5){\pnode{equation}}\GM@label{equation}{\huge$C^A_{i}, C^B_{i}\sim \mathrm{Gaussian}\bigl(0,2)$}

\rput(11.5,2.7){\pnode{equation}}\GM@label{equation}{\huge$D^A_{i}, D^B_{i}\sim \mathrm{Gaussian}\bigl(0,0.5)$}

\rput(11.5,1.9){\pnode{equation}}\GM@label{equation}{\huge$C^A_{i}, C^B_{i}\sim \mathrm{Gaussian}\bigl(0,2)$}

\rput(11.5,0.7){\pnode{equation}}\GM@label{equation}{\huge$D^A_{i}, D^B_{i}\sim \mathrm{Gaussian}\bigl(0,0.5)$}

\rput(11.5,-0.1){\pnode{equation}}\GM@label{equation}{\huge$C^A_{i}, C^B_{i}\sim \mathrm{Gaussian}\bigl(0,2)$}
