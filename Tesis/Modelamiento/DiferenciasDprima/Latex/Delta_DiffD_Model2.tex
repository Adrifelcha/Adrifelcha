...
\rput(7.5,10.2){\GM@node[nodeSize=15mm,
					%observed=true,
					observedColor=lightgray,
					%query=true
					]{Delta}}
					\rput(7.5,10.2){\GM@node[nodeSize=12mm]{Q_small}}
...
\rput(1.4,8){\GM@node[nodeSize=14mm,
					%observed=true,
					observedColor=lightgray,
					%query=true
					]{muca}}
           \GM@label[offset=-4mm]{muca}{\huge$\mu^C_{Ai}$}

\rput(2.6,8){\GM@node[nodeSize=14mm,
					%observed=true,
					observedColor=lightgray,
					%query=true
					]{lamca}}
           \GM@label[offset=-4.5mm]{lamca}{\huge$\lambda^C_{Ai}$}

\rput(4.2,8){\GM@node[nodeSize=14mm,
					%observed=true,
					observedColor=lightgray,
					%query=true
					]{muda}}
           \GM@label[offset=-4mm]{muda}{\huge$\mu^D_{Ai}$}

\rput(5.3,8){\GM@node[nodeSize=14mm,
					%observed=true,
					observedColor=lightgray,
					%query=true
					]{lamda}}
           \GM@label[offset=-4.5mm]{lamda}{\huge$\lambda^D_{Ai}$}

\rput(7.1,8){\GM@node[nodeSize=14mm,
					%observed=true,
					observedColor=lightgray,
					%query=true
					]{mucb}}
           \GM@label[offset=-4mm]{mucb}{\huge$\mu^C_{Bi}$}

\rput(8.3,8){\GM@node[nodeSize=14mm,
					%observed=true,
					observedColor=lightgray,
					%query=true
					]{lamcb}}
           \GM@label[offset=-4.5mm]{lamcb}{\huge$\lambda^C_{Bi}$}
...
\rput(0.70, 0.9){\GM@plate[plateLabelPos=br]{10.5}{9.75}{\Large$i$ Sujeto}}
