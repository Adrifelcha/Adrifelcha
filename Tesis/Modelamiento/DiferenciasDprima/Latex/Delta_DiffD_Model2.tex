...
\rput(11.5,4.3){\pnode{equation}}\GM@label{equation}{\huge$D^A_{i}\sim \mathrm{Gaussian}\bigl(0,0.5)$}

\rput(11.5,3.5){\pnode{equation}}\GM@label{equation}{\huge$C^A_{i}\sim \mathrm{Gaussian}\bigl(0,2)$}

\rput(11.5,2.7){\pnode{equation}}\GM@label{equation}{\huge$D^B_{i}\sim \mathrm{Gaussian}\bigl(0,0.5)$}

\rput(11.5,1.9){\pnode{equation}}\GM@label{equation}{\huge$C^B_{i}\sim \mathrm{Gaussian}\bigl(0,2)$}
