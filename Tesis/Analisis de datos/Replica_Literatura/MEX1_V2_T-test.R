...
#### Diferencias en Confidence Rate POR OUTCOME
#Llamamos los datos
...
#Corremos la T
t.test(values~ind,data=Misses_C,alternative = c("two.sided", "less", "greater"))
t.test(values~ind,data=Hits_C,alternative = c("two.sided", "less", "greater"))
t.test(values~ind,data=Rejections_C,alternative = c("two.sided", "less", "greater"))
t.test(values~ind,data=Falarms_C,alternative = c("two.sided", "less", "greater"))
