...
#############################################
  ...
  jaime <- read.csv(archive)
    ...
    mtext("Color", side = 1, line = 2.5, cex = 1.6)
    mtext("Hits", side = 2, line = 2.3, cex = 1.6, las = 0)
    mtext('Hits por color',3,cex=1.8, line=-0.6)
    ...
    mtext("Color", side = 1, line = 2.5, cex = 1.6)
    mtext("Falsas Alarmas", side = 2, line = 2.4, cex = 1.6, las = 0)
    mtext('F. Alarmas por Color',3, cex=1.8, line=-0.5)
...
####################################################
  ...
  jaime <- read.csv(archive)
    ...
    mtext("Número de Respuestas", side = 1, line = 2.5, cex = 1.8)
    mtext("Color", side = 4, line=0.8, cex = 1.8, font = 1, las = 3)
    #mtext('Sí por color',3,cex=1.5, font=2)
    mtext(archive, outer = TRUE, line = -3.5, cex=2.6, font=2)