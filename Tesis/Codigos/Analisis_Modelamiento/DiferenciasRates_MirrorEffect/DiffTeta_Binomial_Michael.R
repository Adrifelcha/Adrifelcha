...
myinits <- list(
  list(lam_thetah_A = 1, lam_thetaf_A = 1, lam_thetah_B = 1, lam_thetaf_B = 1, Mu_thetah = 0, Mu_thetaf = 0, Tau_H = 0, Tau_F = 0))      #Valores iniciales para las extracciones de las cadenas de Markov
