...
#Diferencias en D'
##########################################################
#Modelo 1 :  Diferencia en D' individuales (Parametro Delta)
##########################################################
...
samples <- jags(data, inits=myinits, parameters,
                model.file ="C:/Users/Alejandro/Desktop/Felisa/Tesis/Codigos/Analisis_Modelamiento/DiferenciasDprima/DiffD_Modelo1_DeltaINSIDEloop.txt",
