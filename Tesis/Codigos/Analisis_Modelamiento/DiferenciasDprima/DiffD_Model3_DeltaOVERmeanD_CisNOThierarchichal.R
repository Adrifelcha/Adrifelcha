...
myinits <- list(
  list(d_A = rep(0,k), d_B = rep(0,k), c_A = rep(0,k), c_B = rep(0,k), mud_A = 0, lambdad_A = 1, mud_B = 0, lambdad_B = 1))

# Parametros monitoreados
parameters <- c("c_A", "c_B", "d_A", "d_B", "thetah_A", "thetah_B", "thetaf_A", "thetaf_B", "mud_A", "mud_B", "sigmad_A", "sigmad_B", "delta")
...
samples <- jags(data, inits=myinits, parameters,
                model.file ="C:/Users/Alejandro/Desktop/Felisa/Tesis/Codigos/Analisis_Modelamiento/DiferenciasDprima/DiffD_Model3_DeltaOVERmeanD_CisNOThierarchichal.txt",
