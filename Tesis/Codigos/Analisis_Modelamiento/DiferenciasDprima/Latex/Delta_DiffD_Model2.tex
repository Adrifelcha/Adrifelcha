...
\rput(2,4.2){\GM@node[nodeSize=17mm,
					%observed=true,
					observedColor=lightgray,
					%query=true
					]{TetaHA}}
					\rput(2,4.2){\GM@node[nodeSize=14mm]{Q_small}}
           \GM@label[offset=-5.5mm]{TetaHA}{\huge$\theta h^A_{i}$}
\rput(5,4.2){\GM@node[nodeSize=17mm,
					%observed=true,
					observedColor=lightgray,
					%query=true
					]{TetaFAA}}
					\rput(5,4.2){\GM@node[nodeSize=14mm]{Q_small}}
...
\rput(10,4.2){\GM@node[nodeSize=17mm,
					%observed=true,
					observedColor=lightgray,
					%query=true
					]{TetaFAB}}
					\rput(10,4.2){\GM@node[nodeSize=14mm]{Q_small}}
