...
\rput(11.5,4){\pnode{equation}}\GM@label{equation}{\huge$C_{i}\sim \mathrm{Gaussian}(0,1))$}

\rput(11.5,2){\pnode{equation}}\GM@label{equation}{\huge$\mu^D_{j}\sim \mathrm{Gaussian}\bigl(0,0.001)$}

\rput(11.5,1){\pnode{equation}}\GM@label{equation}{\huge$\lambda^D_{j}\sim \mathrm{Gamma}\bigl(.001,.001)$}
