...
\rput(2.8,8.7){\GM@node[nodeSize=14mm,
           ...
           \GM@label[offset=-4mm]{muca}{\huge$\mu^C$}
...
\rput(4.5,8.7){\GM@node[nodeSize=14mm,
           ...
           \GM@label[offset=-4.5mm]{lamca}{\huge$\lambda^C$}
...
\rput(11.5,4){\pnode{equation}}\GM@label{equation}{\huge$C_{i}\sim \mathrm{Gaussian}\bigl(\mu^C,\lambda^C)$}


\rput(11.5,2){\pnode{equation}}\GM@label{equation}{\huge$\mu^C, \mu^D_{j}\sim \mathrm{Gaussian}\bigl(0,0.001)$}

\rput(11.5,1){\pnode{equation}}\GM@label{equation}{\huge$\lambda^C, \lambda^D_{j}\sim \mathrm{Gamma}\bigl(.001,.001)$}

\rput(11.5,-1){\pnode{equation}}\GM@label{equation}{\huge$\delta \gets \mu^D_{1}-\mu^D_{2}$}
