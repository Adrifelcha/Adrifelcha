...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.00), mayo 07, 2015, at 17:49
...
expName = 'Ebbinghaus_onDemo'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Adriana\\Dropbox\\Octavo Semestre\\Taller de investigacion\\Ebbinghaus PsychoPy\\Ebbinghaus_onDemo.psyexp',
...
text_4 = visual.TextStim(win=win, ori=0, name='text_4',
    text=u"\xa1Bienvenido!\n\nEst\xe1s a punto de participar en un experimento para Proyecto de Tesis elaborado en la Facultad de Psicolog\xeda, UNAM.\n\n\nA continuaci\xf3n se te presentar\xe1n dos figuras compuestas cada una por un c\xedrculo central con algunos c\xedrculos al rededor. Tu tarea consistir\xe1 en identificar los casos en que ambos c\xedrculos centrales sean del mismo tama\xf1o.\n\nCuando detectes un caso en que los c\xedrculos centrales son iguales, presiona la tecla 'i'. Si los c\xedrculos c\xe9ntricos no son del mismo tama\xf1o, presiona 'o'\r\n\r\nPresiona la barra espaciadora para continuar",    font='Arial',
...
text_5 = visual.TextStim(win=win, ori=0, name='text_5',
    text=u"Por ejemplo, aqu\xed el c\xedrculo central de la figura derecha es m\xe1s grande que el de la izquierda. En este caso la respuesta correcta es: que NO son iguales (Deber\xedas presionar 'o')\n\r\n\nTrata de ser tan preciso como puedas. \n\nNo hay l\xedmite de tiempo para que emitas tus respuestas, sin embargo, dado que el experimento puede ser un tanto extenso, se te recomienda que no te tomes tanto tiempo por ensayo.\n\n\nPara comenzar con el experimento, apreta la Barra Espaciadora.",    font='Arial',
...
trials = data.TrialHandler(nReps=6, method='random', 
    extraInfo=expInfo, originPath='C:\\Users\\Adriana\\Dropbox\\Octavo Semestre\\Taller de investigacion\\Ebbinghaus PsychoPy\\Ebbinghaus_onDemo.psyexp',
