...
#
mybaseline=open("MirrorEx2b_E1"+"_"+options["Participante"]+"_"+time.strftime("%Y-%m-%d")+"_"+"2AFC.csv", 'w')
...
#		choice=192
		...
		if choice==1:
			...
			img3=visual.ImageStim(mywindow, image="ccentral_az.png", pos=[0,10],size=[2,2])
		...
		if choice==2:
			...
			img3=visual.ImageStim(mywindow, image="ccentral_ver.png", pos=[0,10],size=[2,2])
		...
		if choice==3:
			...
			img3=visual.ImageStim(mywindow, image="ccentral_pur.png", pos=[0,10],size=[2,2])
		...
		if choice==4:
			...
			img3=visual.ImageStim(mywindow, image="ccentral_an.png", pos=[0,10],size=[2,2])
		...
		if choice==8:
			...
			img3=visual.ImageStim(mywindow, image="ccentral_az.png", pos=[0,10],size=[2,2])
			img4=visual.ImageStim(mywindow, image="ccentral_az.png", pos=[-18,-2],size=[1.5,1.5])
		...
		if choice==28:
			img1=visual.ImageStim(mywindow, image="cext_over2_pur.png", pos=[-17,-3])
			img2=visual.ImageStim(mywindow, image="cext_under3_pur.png", pos=[17,-2])
			img3=visual.ImageStim(mywindow, image="ccentral_pur.png", pos=[0,10],size=[2,2])
			img4=visual.ImageStim(mywindow, image="ccentral_pur.png", pos=[-17,-3],size=[2.5,2.5])
			img5=visual.ImageStim(mywindow, image="ccentral_pur.png", pos=[16,-2],size=[2,2])
		if choice==29:
			img1=visual.ImageStim(mywindow, image="cext_under3_az.png", pos=[-17,-2])
			img2=visual.ImageStim(mywindow, image="cext_over3_az.png", pos=[17,-3])
			img3=visual.ImageStim(mywindow, image="ccentral_az.png", pos=[0,10],size=[2,2])
		...
		if choice==31:
			...
			img3=visual.ImageStim(mywindow, image="ccentral_pur.png", pos=[0,10],size=[2,2])
			img4=visual.ImageStim(mywindow, image="ccentral_pur.png", pos=[-18,-2],size=[2,2])
...
#AN-BN
		...
		if choice==180:
			...
			img2=visual.ImageStim(mywindow, image="cext_over2_ver.png", pos=[17,-2])
			img3=visual.ImageStim(mywindow, image="ccentral_ver.png", pos=[0,10],size=[2,2])
			img4=visual.ImageStim(mywindow, image="ccentral_ver.png", pos=[-18,-1],size=[2.5,2.5])
			img5=visual.ImageStim(mywindow, image="ccentral_ver.png", pos=[17,-2],size=[1.5,1.5])
		if choice==181:
			img1=visual.ImageStim(mywindow, image="cext_over3_pur.png", pos=[-17,-2])
			img2=visual.ImageStim(mywindow, image="cext_under8_pur.png", pos=[18,-1])
		...
		if choice==191:
			...
			img2=visual.ImageStim(mywindow, image="cext_under7_pur.png", pos=[18,-1])
			img3=visual.ImageStim(mywindow, image="ccentral_pur.png", pos=[0,10],size=[2,2])
			img4=visual.ImageStim(mywindow, image="ccentral_pur.png", pos=[-18,-2],size=[1.5,1.5])
...
#		txtRecordat2=visual.ImageStim(mywindow,image="Right.png", pos=[17,14])
#		txtRecordat3=visual.ImageStim(mywindow,image="Left.png", pos=[-17,14])
#		txtRecordat1.draw()
#		txtRecordat2.draw()
#		txtRecordat3.draw()
		img1.draw()
