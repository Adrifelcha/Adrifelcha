...
options={"Experimento":"2a","Descripcion":"Una Figura", "Procedimiento":"Y/N +Rating","Participante":"Usuario1"}
...
#
mybaseline=open("MirrorEx2a"+"_"+options["Participante"]+"_"+time.strftime("%Y-%m-%d")+"_"+"Y_N+R.csv", 'w')
#mybaseline=open("MirrorEx2a"+"_"+options["Participante"]+"_"+"2016-05-16"+"_"+"Y_N+R.csv", 'w')
