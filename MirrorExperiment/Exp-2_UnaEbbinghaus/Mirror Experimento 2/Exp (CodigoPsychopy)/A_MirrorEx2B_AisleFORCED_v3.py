...
txtResults=visual.TextStim(mywindow,text="A cada lado del Circulo de Referencia, aparecera un circulo del mismo color rodeado por una serie de circulos de distinto tamano, que permanecera a la vista por un segundo. Dichos circulos apareceran siempre de izquierda a derecha.",wrapWidth = 35,pos=[0,13], color=[0,0,0], colorSpace="rgb255")
txtRes=visual.TextStim(mywindow,text="Presiona la barra espaciadora",wrapWidth = 30,pos=[0,-15], color=[0,0,0], colorSpace="rgb255")
img3.draw()
txtResults.draw()
txtRes.draw()
mywindow.update()
...
txtRes=visual.TextStim(mywindow,text="Presiona la barra espaciadora para volver a ver el ejemplo",wrapWidth = 30,pos=[0,-15], color=[0,0,0], colorSpace="rgb255")
#img1.draw()
#img2.draw()
#img3.draw()
#img4.draw()
...
txtResults=visual.TextStim(mywindow,text="Por ejemplo, en este caso el circulo central de la figura derecha (el segundo en aparecer) fue mucho mas pequeno que el Circulo de Referencia. En tanto que, el circulo del lado izquierdo parece tener el mismo tamano. Deberias presionar la Tecla IZQUIERDA",wrapWidth = 45,pos=[0,12], color=[0,0,0], colorSpace="rgb255")
...
mywindow.setColor(color=[255,255,255], colorSpace="rgb255")
mywindow.update()
txtResults=visual.TextStim(mywindow,text="En cada ensayo DEBERAS ELEGIR UNA de las dos figuras laterales: La que contenga el circulo central CUYO TAMANO SE PAREZCA MAS al Circulo de Referencia. ESPERA A QUE SE TE HAYAN MOSTRADO AMBAS PARA RESPONDER."+"\n"+"\n"+"\n"+"\n"+"Elige siempre la opcion de la cual estes mas seguro(a)."+"\n"+"\n"+"\n"+"\n"+"Presiona la barra espaciadora para continuar",wrapWidth = 45,color=[0,0,0], colorSpace="rgb255")
txtResults.draw()
mywindow.update()
while 'space' not in event.getKeys(): 
	core.wait(0.1)
