...
for i in range (1):
	...
	if choice==1:
		img1=visual.ImageStim(mywindow, image="ccentral.png", pos=[-15,-4], size=[3,3])

		img2=visual.ImageStim(mywindow, image="ccentral.png", pos=[10,-4], size=[2,2])

	img3=visual.ImageStim(mywindow, image="cexternochico2.png", pos=[10,-4], size=[8,10])

	txtResults=visual.TextStim(mywindow,text="Ejemplo: "+"\n"+"\n"+"En este caso el circulo central de la figura derecha es mas chico que el circulo aislado del lado izquierdo."+"\n"+"\n"+"Presiona la tecla N porque NO son iguales",wrapWidth = 30,pos=[0,7], color=[0,0,0], colorSpace="rgb255")
	img1.draw()
	img2.draw()
	img3.draw()
	txtResults.draw()
...
for i in range (336):
	...
	if choice==1:
		...
		img2=visual.ImageStim(mywindow, image="ccentral.png", pos=[10,0], size=[2,2])
	        ...
	        img3=visual.ImageStim(mywindow, image="cexternochico2.png", pos=[10,0])
	if choice==2:
		img1=visual.ImageStim(mywindow, image="ccentral.png", pos=[-15,0], size=[3,3])

		img2=visual.ImageStim(mywindow, image="ccentral.png", pos=[10,0], size=[2,2])

	        img3=visual.ImageStim(mywindow, image="cexternogrande2.png", pos=[10,0])
	if choice==3:
		img1=visual.ImageStim(mywindow, image="ccentral.png", pos=[-15,0], size=[3,3])

		img2=visual.ImageStim(mywindow, image="ccentral.png", pos=[10,0], size=[2,2])

	        img3=visual.ImageStim(mywindow, image="cexternochico3.png", pos=[9.5,1])
	if choice==4:
		img1=visual.ImageStim(mywindow, image="ccentral.png", pos=[-15,0], size=[3,3])

		img2=visual.ImageStim(mywindow, image="ccentral.png", pos=[10,0.5], size=[2,2])

	        img3=visual.ImageStim(mywindow, image="cexternogrande3.png", pos=[9,0])
	if choice==5:
		img1=visual.ImageStim(mywindow, image="ccentral.png", pos=[-15,0], size=[3,3])

		img2=visual.ImageStim(mywindow, image="ccentral.png", pos=[10,0], size=[2,2])

	        img3=visual.ImageStim(mywindow, image="cexternochico4.png", pos=[10,0])
	if choice==6:
		img1=visual.ImageStim(mywindow, image="ccentral.png", pos=[-15,0], size=[3,3])

		img2=visual.ImageStim(mywindow, image="ccentral.png", pos=[10,0], size=[2,2])

	        img3=visual.ImageStim(mywindow, image="cexternogrande4.png", pos=[10,0], size=[22,22])
	if choice==7:
		img1=visual.ImageStim(mywindow, image="ccentral.png", pos=[-15,0], size=[3,3])
	...
	if choice==10:
		...
		img2=visual.ImageStim(mywindow, image="ccentral.png", pos=[10,0.5], size=[2.5,2.5])
	...
	if choice==40:
		...
		img2=visual.ImageStim(mywindow, image="ccentral.png", pos=[10,0.5], size=[3.5,3.5])
	...
	if choice==46:
		...
		img2=visual.ImageStim(mywindow, image="ccentral.png", pos=[10,0.5], size=[4,4])
	...
	if choice==47:
		...
		img2=visual.ImageStim(mywindow, image="ccentral.png", pos=[10,0], size=[4,4])
	        ...
	        img3=visual.ImageStim(mywindow, image="cexternochico4.png", pos=[9,0])
	if choice==48:
		img1=visual.ImageStim(mywindow, image="ccentral.png", pos=[-15,0], size=[3,3])
