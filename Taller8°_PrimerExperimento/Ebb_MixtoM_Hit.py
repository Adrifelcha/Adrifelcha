...
mywindow.setColor(color=[255,255,255], colorSpace="rgb255")
mywindow.update()
txtResults=visual.TextStim(mywindow,text="Segunda Fase: "+"\n"+"\n"+"Las instrucciones siguen siendo las mismas" +"\n"+"\n"+"PERO ahora acumularas PUNTOS cada vez que detectes eficientemente un ensayo en que los circulos SI sean iguales."+"\n"+"\n"+"Si se te van mas de 15 ensayos con circulos iguales sin reportarlo: Pierdes. Si por el contrario, ganas, se te premiara al final del experimento."+"\n"+"\n"+"Presiona la tecla E para comenzar",wrapWidth = 30,color=[0,0,0], colorSpace="rgb255")
txtResults.draw()
mywindow.update()
while 'e' not in event.getKeys(): 
	core.wait(0.1)
