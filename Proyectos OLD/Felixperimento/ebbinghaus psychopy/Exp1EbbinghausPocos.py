...
mybaseline=open("Exp1Pocos-FA"+ options["Nombre"]+ time.strftime("%Y-%m-%d")+ time.strftime("%H.%M.%S")+ "Baseline.csv", 'w')

mytestline=open("Exp1Pocos-FA"+ options["Nombre"]+ time.strftime("%Y-%m-%d")+ time.strftime("%H.%M.%S")+ "TestLine.csv", 'w')
