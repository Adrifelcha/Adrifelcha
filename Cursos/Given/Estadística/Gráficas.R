...
text(0.7,Candidatos[1]+5,paste(Candidatos[1], '%'),cex=1.5,col='black',f=1)
text(1.9,Candidatos[2]+5,paste(Candidatos[2], '%'),cex=1.5,col='black',f=1)
text(3.1,Candidatos[3]+5,paste(Candidatos[3], '%'),cex=1.5,col='black',f=1)
mtext("Candidato", side = 1, line = 3, cex = 1, font = 2)
mtext("Proporción de -Favorable-", side = 4, line = 0, cex = 1, font = 2, las = 0)
mtext("2012 Presidential Run: GOP Candidates",3,cex=2, line=1.5, font=2)
