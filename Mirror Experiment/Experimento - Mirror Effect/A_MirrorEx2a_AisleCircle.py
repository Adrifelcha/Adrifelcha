...
options={"Experimento":"2a","Opcion":"Y/N +Rating","Participante":"Usuario1"}
...
#FIRST INSTRUCTIONS
#
txtResults=visual.TextStim(mywindow,text="Instrucciones: "+"\n"+"\n"+"En la pantalla se te mostraran dos circulos de color claro, el circulo derecho aparecera rodeado por circulos de distinto tamano" +"\n"+"\n"+"Presiona la tecla S cuando el circulo central de la figura derecha SI sea del mismo tamano que el circulo aislado izquierdo "+"\n"+"\n"+"Si NO son iguales, oprime N"+"\n"+"\n"+"Presiona la barra espaciadora para continuar",wrapWidth = 30,color=[0,0,0], colorSpace="rgb255")
txtResults.draw()
mywindow.update()
...
img3=visual.ImageStim(mywindow, image="ccentral_an.png", pos=[-15,-5], size=[2.5,2.5])
...
for j in range(1):
	...
	for i in range (800):
		...
		if choice==640:
			...
			img3=visual.ImageStim(mywindow, image="ccentral_an.png", pos=[-15,0],size=[3,3])
			img4=visual.ImageStim(mywindow, image="ccentral_an.png", pos=[10,0],size=[2.5,2.5])
		txtRecordat1=visual.TextStim(mywindow,text="El circulo central de la figura derecha es del mismo tamano que el circulo aislado izquierdo?",wrapWidth = 45,color=[0,0,0], pos=[0,10], bold="True", colorSpace="rgb255")
		txtRecordat2=visual.TextStim(mywindow,text="S = Si",wrapWidth = 45,color=[0,0,0], pos=[0,-10], bold="True", colorSpace="rgb255")
		txtRecordat3=visual.TextStim(mywindow,text="N = No",wrapWidth = 45,color=[0,0,0], pos=[0,-15], bold="True", colorSpace="rgb255")
		txtRecordat1.draw()
		txtRecordat2.draw()
